...
/* Pre-computed floating-point division constants for performance */
struct aspect_ratio_elem aspectratio_lut[ASPECT_RATIO_END] = {
   { 1.33333333f , "4:3"           },    /* 4.0f / 3.0f   */
   { 1.77777778f , "16:9"          },    /* 16.0f / 9.0f  */
   { 1.6f        , "16:10"         },    /* 16.0f / 10.0f */
   { 1.06666667f , "16:15"         },    /* 16.0f / 15.0f */
   { 2.33333333f , "21:9"          },    /* 21.0f / 9.0f  */
   { 1.0f        , "1:1"           },    /* 1.0f / 1.0f   */
   { 2.0f        , "2:1"           },    /* 2.0f / 1.0f   */
   { 1.5f        , "3:2"           },    /* 3.0f / 2.0f   */
   { 0.75f       , "3:4"           },    /* 3.0f / 4.0f   */
   { 4.0f        , "4:1"           },    /* 4.0f / 1.0f   */
   { 0.5625f     , "9:16"          },    /* 9.0f / 16.0f  */
   { 1.25f       , "5:4"           },    /* 5.0f / 4.0f   */
   { 1.2f        , "6:5"           },    /* 6.0f / 5.0f   */
   { 0.77777779f , "7:9"           },    /* 7.0f / 9.0f   */
   { 2.66666667f , "8:3"           },    /* 8.0f / 3.0f   */
   { 1.14285714f , "8:7"           },    /* 8.0f / 7.0f   */
   { 1.58333333f , "19:12"         },    /* 19.0f / 12.0f */
   { 1.35714286f , "19:14"         },    /* 19.0f / 14.0f */
   { 1.76470588f , "30:17"         },    /* 30.0f / 17.0f */
   { 3.55555556f , "32:9"          },    /* 32.0f / 9.0f  */
